...
<table class="table">
  <thead>
    ...
    <tr>
      <th>Description</th>
      <th>{{$selectedItem[0]->description}} {{$selectedItem[0]->description}}</th>
    </tr>
    <tr>
      <th>Available</th>
...
@csrf
  <div class="form-row">
      <input required name="productName" type="text" class="form-control" id="inputEmail4" placeholder="Quantity">
    </div>
    </th>  
    <th>
    <div class="form-row">
